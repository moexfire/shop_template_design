                        ...
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cart_price">
                                        <p>JP¥{{$cart_data->price}}</p>
                                    </td>
                                    <td class="cart_quantity">
                                        <p>{{$cart_data->quantity}}</p>
                                    </td>
                                    <td class="cart_total">
                                        <p class="cart_total_price">JP¥ {{$cart_data->price*$cart_data->quantity}}</p>
                                    </td>
                                </tr>
                                @endforeach
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <table class="table table-condensed total-result">
                                            <tr>
                                                ...
                                                <td>JP¥ {{$total_price}}</td>
                                            </tr>
                                            @if(Session::has('discount_amount_price'))
                                            <tr class="shipping-cost">
                                                <td>Coupon Discount</td>
                                                <td>JP¥ {{Session::get('discount_amount_price')}}</td>
                                            </tr>
                                            <tr>
                                                <td>Total</td>
                                                <td><span>JP¥ {{$total_price-Session::get('discount_amount_price')}}</span></td>
                                            </tr>
                                            @else
                                            <tr>
                                                <td>Total</td>
                                                <td><span>JP¥ {{$total_price}}</span></td>
                                            </tr>
                                            @endif
                                        </table>
                                    </td>
