            ...
            <div class="col-sm-6">
                ...
                <div class="total_area">
                    <ul>
                        ...
                        @else
                        <li>合計価格 <span>¥ {{$total_price}}</span></li>
                        @endif
                    </ul>
                    <div style="margin-left: 20px;"><a class="btn btn-default check_out" href="{{url('/check-out')}}">購入する</a></div>
                </div>
            </div>
        </div>
    </div>
